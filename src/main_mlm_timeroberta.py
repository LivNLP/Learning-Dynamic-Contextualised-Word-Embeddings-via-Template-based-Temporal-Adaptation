...
from transformers import RobertaForMaskedLM, AutoTokenizer, DataCollatorForLanguageModeling
...
def main():
    ...
    if args.checkmode == 1:
        state_dict = torch.load('{}/mlm_{}_trainedroberta_{year2}_{year2}.torch'.format(args.trained_dir,args.dataset, year2 = args.year2), map_location="cuda:0")
    if args.checkmode == 2:
        state_dict = torch.load('{}/mlm_{}_trainedroberta_{year1}_{year2}.torch'.format(args.trained_dir,args.dataset, year1 = args.year1, year2 = args.year2), map_location="cuda:0")
    ...
    for epoch in range(1, args.n_epochs + 1):
        ...
        #warm up + decay
        # if epoch <= int(epoch_num * 0.1):
        #     for params in optimizer.param_groups:
        #         params['lr'] += args.lr / (epoch_num * 0.1)
        # elif epoch > int(epoch_num * 0.1):
        #     for params in optimizer.param_groups:
        #         params['lr'] -= args.lr / (epoch_num * 0.9)
