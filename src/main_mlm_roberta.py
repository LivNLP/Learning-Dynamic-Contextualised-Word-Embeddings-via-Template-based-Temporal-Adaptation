...
def main():
    ...
    print("Data loader")
    if args.checkmode == 1: filename = 'mlm_{}_trainedroberta_{}_{}'.format(args.dataset,args.year1,args.year2)
    else: filename = 'mlm_{}_roberta_{}_{}'.format(args.dataset,args.year1,args.year2)
    ...
    # state_dict = torch.load('{}/mlm_{}_trainedbert_{year1}_{year2}.torch'.format(args.trained_dir, args.dataset, year1 = args.year1, year2 = args.year2))
        ...
        if args.checkmode == 1:
            ...
            if best_perplexity is None:
                ...
                if best_perplexity > perplexity_dev:
                    ...
                    torch.save(model.state_dict(), '{}/{}.torch'.format(args.trained_dir, filename))
                    #compare with DCWE
                    # if perplexity_test < 5.902: break
                else:
                    early_stop_count += 1
